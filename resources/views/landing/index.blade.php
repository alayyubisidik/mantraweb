                    ...
                    <div class="col-xl-11">
                        <div class="tp-hero-title-box text-center">
                            <h2 class="tp-hero-title-3 hero-text-anim pb-5">
                                ...
                                <i><i class="child-1">untuk Bisnis Digital Anda.</i></i>
                            </h2>
                            <p class=" tp-char-animation-2">Dapatkan dukungan teknologi terbaik untuk bisnis dan menjangkau
                                lebih banyak pelanggan. <br> Semua bisa Anda lakukan dalam satu tempat.</p>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-4 col-lg-4">
                            <div
                                class="tp-barnd-left-item d-flex align-items-center justify-content-center justify-content-lg-start">
                                <h5 class="tp-barnd-title-sm text-center text-lg-start">Beberapa mitra dan klien <br> yang
                                    telah mempercayai kami</h5>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".6s">
                        ...
                        <div class="tp-sales-feature pb-20">
                            <ul>
                                <li class="yellow-1"><span><i class="far fa-check"></i> <em>Teknologi terbaru dan
                                            teruji.</em></span></li>
                                <li class="purple-2"><span><i class="far fa-check"></i> <em>Desain custom dan
                                            eksklusif.</em></span></li>
                                <li class="green-3"><span><i class="far fa-check"></i> <em>Proses cepat dan
                                            terarah.</em></span></li>
                            </ul>
                        </div>
                ...
                <div class="tp-counter-wrapper p-relative">
                    <div class="row gx-0">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div
                                class="tp-counter-wrap d-md-flex justify-content-md-center align-items-md-center text-center">
                                <div class="tp-counter-item">
                                    <h4><span data-purecounter-duration="1" data-purecounter-end="1"
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div
                                class="tp-counter-wrap d-md-flex justify-content-md-center align-items-md-center text-center">
                                <div class="tp-counter-item">
                                    <h4><span data-purecounter-duration="1" data-purecounter-end="5"
                                            class="purecounter">0</span>+</h4>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div
                                class="tp-counter-wrap d-md-flex justify-content-md-center align-items-md-center text-center">
                                <div class="tp-counter-item">
                                    <h4><span data-purecounter-duration="1" data-purecounter-end="98"
                                            class="purecounter">0</span><em>%</em></h4>
                                    <p>Klien Puas</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div
                                class="tp-counter-wrap d-md-flex justify-content-md-center align-items-md-center text-center">
                                <div class="tp-counter-item">
                                    <h4><span data-purecounter-duration="1" data-purecounter-end="10"
                                            class="purecounter">0</span>+</h4>
        ...
        <div class="tp-service-area pb-160">
            <div class="container">
                ...
                <div class="row gy-5 gx-lg-5 gx-4 px-3 px-sm-4 px-md-0">
                    <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mb-md-5 wow tpfadeUp" data-wow-duration=".9s"
                        data-wow-delay=".4s">
                            ...
                            <div class="tp-service-2__item d-flex justify-content-between flex-column">
                                <div class="tp-service-2__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                        viewBox="0 0 24 24" class="duoicon duoicon-building"
                                        style="color: rgb(99, 102, 241);">
                                        <path fill="currentColor" fill-rule="evenodd"
                                            d="M13 3a2 2 0 0 1 1.995 1.85L15 5v14h1V9.5a.5.5 0 0 1 .41-.492L16.5 9H18a2 2 0 0 1 1.995 1.85L20 11v8h1a1 1 0 0 1 .117 1.993L21 21H3a1 1 0 0 1-.117-1.993L3 19h1V5a2 2 0 0 1 1.85-1.995L6 3h7Z"
                                            class="duoicon-secondary-layer" opacity=".3"></path>
                                        <path fill="currentColor" fill-rule="evenodd"
                                            d="M11 7H8v2h3V7Zm0 4H8v2h3v-2Zm0 4H8v2h3v-2Z" class="duoicon-primary-layer">
                                        </path>
                                    </svg>
                                </div>
                                <div class="tp-service-2__text">
                                    <h4 class="tp-service-2__title-sm"><a href="#">Website App</a></h4>
                                    <a class="tp-service-2__link" href="#">Explore<i
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mb-md-5 wow tpfadeUp" data-wow-duration=".9s"
                        ...
                        <div class="tp-service-2__item-wrapper p-relative">
                            <div class="tp-service-2__item d-flex justify-content-between flex-column">
                                <div class="tp-service-2__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                        viewBox="0 0 24 24" class="duoicon duoicon-shopping-bag"
                                        style="color: rgb(99, 102, 241);">
                                        <path fill="currentColor" fill-rule="evenodd"
                                ...
                                <div class="tp-service-2__text">
                                    <h4 class="tp-service-2__title-sm"><a href="#">E-Commerce</a></h4>
                                    <a class="tp-service-2__link" href="#">Explore<i
                                            class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mb-md-5 wow tpfadeUp" data-wow-duration=".9s"
                        ...
                        <div class="tp-service-2__item-wrapper p-relative">
                            <div class="tp-service-2__item d-flex justify-content-between flex-column">
                                <div class="tp-service-2__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                        viewBox="0 0 24 24" class="duoicon duoicon-id-card"
                                        style="color: rgb(99, 102, 241);">
                                ...
                                <div class="tp-service-2__text">
                                    <h4 class="tp-service-2__title-sm"><a href="#">Landing Page</a></h4>
                                    <a class="tp-service-2__link" href="#">Explore<i
                                            class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mb-md-5 wow tpfadeUp" data-wow-duration=".9s"
                        ...
                        <div class="tp-service-2__item-wrapper p-relative">
                            <div class="tp-service-2__item  d-flex justify-content-between flex-column">
                                <div class="tp-service-2__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                        viewBox="0 0 24 24" class="duoicon duoicon-settings"
                                        style="color: rgb(99, 102, 241);">
                                        <path fill="currentColor" fill-rule="evenodd"
                                ...
                                <div class="tp-service-2__text">
                                    <h4 class="tp-service-2__title-sm"><a href="#">Maintenace</a></h4>
                                    <a class="tp-service-2__link" href="#">Explore<i
                                            class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
