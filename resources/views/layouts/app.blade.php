...
<head>
    ...
    <style>
        ...
        .tpoffcanvas .mobile-menu ul li a.active {
            color: #6865FF;
            font-weight: 600;
        }
    ...
    <link rel="stylesheet" href="{{ asset('landing/css/font-awesome-pro.css') }}">
...
<body>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-8 d-none d-lg-block">
                        <div class="header-bottom__main-menu header-bottom__main-menu-3 text-center">
                            <nav id="mobile-menu">
                                <ul>
                                    <li>
                                        <a href="{{ route('pages.home') }}"
                                            class="{{ request()->routeIs('pages.home') ? 'active' : '' }}">Home</a>
                                    </li>
                                    <li>
    ...
    <div class="tpoffcanvas-area">
        <div class="tpoffcanvas">
            ...
            <div class="mobile-menu pt-50"></div>
                                        ...
                                        <div class="tp-footer__contact-info">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <a class="first-child" href="tel:+806(000)8899">+806 (000) 88
                                                        99</a>
                                                </li>
                                                <li>
                                                    <span>
                                                        <svg width="18" height="18" viewBox="0 0 18 18"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="#595B62" stroke-width="1.5"
    ...
    <script src="{{ asset('landing/js/counterup.js') }}"></script>
    <script src="{{ asset('landing/js/wow.js') }}"></script>
    <script src="{{ asset('landing/js/nice-select.js') }}"></script>
    ...
    <script src="{{ asset('landing/js/isotope-pkgd.js') }}"></script>
    <script src="{{ asset('landing/js/imagesloaded-pkgd.js') }}"></script>
    ...
    <script src="{{ asset('landing/js/split-text.min.js') }}"></script>
    <script src="{{ asset('landing/js/ScrollSmoother.min.js') }}"></script>
    <script src="{{ asset('landing/js/parallax-scroll.js') }}"></script>
