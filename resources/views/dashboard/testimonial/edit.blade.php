                    ...
                    <div class="card-body pt-0">
                        <form action="{{ route('testimonials.update', $testimonial) }}"
                                    ...
                                    @if ($testimonial->image_url)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $testimonial->image_url) }}" alt="Logo Lama"
                                                class="img-thumbnail img-fluid mt-2 w-25">
                                        </div>
                                    @endif
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="message" name="message" rows="7" class="form-control @error('message') is-invalid @enderror">{{ $testimonial->message }}</textarea>
                                    @error('message')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        {{-- <form action="{{ route('testimonials.update', ['testimonialId' => $testimonial->id]) }}" method="POST" class="needs-validation" novalidate
